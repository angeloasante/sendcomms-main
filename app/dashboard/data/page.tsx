    ...
    <div className="flex-1 overflow-y-auto p-8 scroll-smooth">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <h1 className="text-2xl font-semibold text-white tracking-tight">Data Bundles Overview</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#121316] border border-white/5 rounded-xl p-5 shadow-sm">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <div className="text-sm text-gray-400 font-medium">Total Purchases</div>
                ...
                <div className="space-y-3 mt-4">
                  <div>
                    <div className="flex justify-between text-xs mb-1.5">
                      ...
                      <span className="text-gray-300 font-medium">{stats?.successful_count || 0}</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-xs mb-1.5">
                      ...
                      <span className="text-gray-300 font-medium">{stats?.pending_count || 0}</span>
                    </div>
                    <div className="w-full bg-white/5 rounded-full h-1.5">
                ...
                <div className="space-y-3 mt-4">
                  <div>
                    <div className="flex justify-between text-xs mb-1.5">
                      ...
                      <span className="text-gray-300 font-medium">{stats?.processing_count || 0}</span>
                    </div>
                    <div className="w-full bg-white/5 rounded-full h-1.5">
                  ...
                  <div>
                    <div className="flex justify-between text-xs mb-1.5">
                      ...
                      <span className="text-gray-300 font-medium">{stats?.refunded_count || 0}</span>
                    </div>
                    <div className="w-full bg-white/5 rounded-full h-1.5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 bg-[#121316] border border-white/5 rounded-xl p-6 relative overflow-hidden">
                <div className="flex items-center justify-between mb-8">
                  <h3 className="text-sm font-semibold text-white">Purchase Trend</h3>
              ...
              <div className="bg-[#121316] border border-white/5 rounded-xl p-6">
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="text-xs text-gray-500">Total Data Spending</div>
                </div>

                {/* Pricing Breakdown */}
                <div className="space-y-4 border-t border-white/5 pt-4">
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-gray-400">Total Purchases</span>
                    <span className="text-sm font-medium text-white">{stats?.successful_count || 0}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-gray-400">Avg. per Purchase</span>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-white/[0.02] border-b border-white/5">
                      <th className="px-6 py-4 text-[11px] font-semibold text-gray-500 uppercase tracking-wider font-mono">Transaction ID</th>
                      <th className="px-6 py-4 text-[11px] font-semibold text-gray-500 uppercase tracking-wider">Phone Number</th>
                      <th className="px-6 py-4 text-[11px] font-semibold text-gray-500 uppercase tracking-wider">Operator</th>
                      <th className="px-6 py-4 text-[11px] font-semibold text-gray-500 uppercase tracking-wider">Package</th>
                    ...
                    {loading ? (
                      ...
                      <tr>
                        <td colSpan={8} className="px-6 py-12 text-center text-gray-500">
                          ...
                          <p className="text-sm font-medium text-gray-400 mb-1">No data purchases yet</p>
                          <p className="text-xs text-gray-500">Data bundle purchases through the API will appear here</p>
                        </td>
                      </tr>
                    ) : (
                      purchases.map((purchase) => (
                        <tr key={purchase.id} className="group hover:bg-white/[0.02] transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <div className="text-sm font-medium text-white">{purchase.phone_number}</div>
                            {purchase.country_name && (
                              <div className="text-xs text-gray-500">{purchase.country_name}</div>
                            )}
                          </td>
                          ...
                          <td className="px-6 py-4">
                            <div className="text-sm font-medium text-white">{purchase.data_amount || '-'}</div>
                            {purchase.validity && (
                              <div className="text-xs text-gray-500">{purchase.validity}</div>
                            )}
                          </td>
